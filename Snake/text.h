...
public:
	...
	void setFont( int size,std::string fpath = "VT323\\VT323-Regular.ttf"){
	...
	Text(int size,std::string fpath = "VT323\\VT323-Regular.ttf"){
		setFont(size,fpath);
	}
	Text(std::string t,int size,std::string fpath = "VT323\\VT323-Regular.ttf"){
